...
export interface InitOutput {
  ...
  readonly stp_file_request: (a: number) => number;
  readonly runrust: () => number;
  readonly __wbindgen_malloc: (a: number, b: number) => number;
  readonly __wbindgen_realloc: (a: number, b: number, c: number, d: number) => number;
  readonly __wbindgen_export_2: WebAssembly.Table;
  readonly __wbindgen_export_3: WebAssembly.Table;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2cf1cf40a5079a20: (a: number, b: number) => void;
  readonly closure379_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure381_externref_shim: (a: number, b: number, c: number, d: number) => void;
  readonly closure774_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure995_externref_shim: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __externref_table_alloc: () => number;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly closure1465_externref_shim: (a: number, b: number, c: number, d: number) => void;
