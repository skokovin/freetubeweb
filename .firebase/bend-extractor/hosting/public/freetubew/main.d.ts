...
export interface InitOutput {
  ...
  readonly closure399_externref_shim: (a: number, b: number, c: number) => void;
  ...
  readonly closure404_externref_shim: (a: number, b: number, c: number, d: number) => void;
  readonly closure1374_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure1778_externref_shim: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __externref_table_alloc: () => number;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly closure3352_externref_shim: (a: number, b: number, c: number, d: number) => void;
