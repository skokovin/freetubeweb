...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5beefe69128b222c: (a: number, b: number) => void;
...
export const closure836_externref_shim: (a: number, b: number, c: any) => void;
export const closure1329_externref_shim: (a: number, b: number, c: any, d: any) => void;
